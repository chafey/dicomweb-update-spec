...
describe('Move Series', function () {
  describe('Happy Paths', function () {
    it('TODO: should create new patient', async function () { });
    it('TODO: should create new patient and study', async function () { });
    it('TODO: should move the series to an existing patient/study', async function () { });
    it('TODO: should move the series to an existing patient/study and change the series instance uid', async function () { });
